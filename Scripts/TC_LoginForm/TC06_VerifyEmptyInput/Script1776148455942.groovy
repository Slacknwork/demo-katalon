...
if (expectedResult == GlobalVariable.EMPTY) {
	...
	WebUI.verifyElementVisible(findTestObject('LoginFormElements/ErrorMessage/text_emptyEmail'))
	
	//Verify 'No empty field!' message in password field
	WebUI.verifyElementVisible(findTestObject('LoginFormElements/ErrorMessage/text_emptyPassword'))
}else {
	...
	if (expectedResult == GlobalVariable.EMPTY_EMAIL) {
		//Verify 'No empty field!' message in password field
	...
	}else if (expectedResult == GlobalVariable.EMPTY_PASSWORD) {
		//Verify 'No empty field!' message in password field
